...
function Exposure() { 
  ...
  const columns = [ 
    ...
    { 
      dataField: "Current Reserves", 
      text: "Current Reserves", 
      sort: true, 
      headerClasses: "Current Reserves-header", 
      classes: "Current Reserves-column", 
      formatter: (cellContent, row) => ( 
          <div className='row'> 
            <div className='col-12'> 
            </div> 
    ...
    { 
        dataField: "Scheduled Payments", 
        text: "Scheduled Payments", 
        sort: true, 
        headerClasses: "Scheduled Payments-header", 
        classes: "Scheduled Payments-column", 
        formatter: (cellContent, row) => ( 
            <div className='row'> 
              <div className='col-12'> 
              </div> 
      ...
      { 
        dataField: "Paid to Date", 
        text: "Paid to Date", 
        sort: true, 
        headerClasses: "Paid to Date-header", 
        classes: "Paid to Date-column", 
        formatter: (cellContent, row) => ( 
            <div className='row'> 
              <div className='col-12'> 
              </div> 
