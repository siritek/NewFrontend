...
var policylevelDataObj; 
function Policylevel({onSave}) { 
  ...
  function handleSubmit() { 
    ...
    policylevelDataObj = updatedInputArr; 
 
    console.log(policylevelDataObj); 
  } 
  ...
  function handleAdd() { 
    setInputarr([ 
      ...
      { 
        checked: false, 
        policylevelCoverageType : "", 
        policylevelIncidentLimits: "", 
        policylevelPerPersonLimit: "", 
        submitted: false,  
      }, 
    ]); 
  } 
                    ...
                    !info.deleted && ( 
                      <tr key={ind}> 
                        ...
                        <td> 
                          {!info.submitted ? ( 
                            <Form.Select 
                              value={info.policylevelCoverageType} 
                              onChange={(e) => 
                                handleChange(e, ind, "policylevelCoverageType") 
                              } 
                            > 
                        ...
                        <td> 
                          {!info.submitted ? ( 
                            <input 
                              type="text" 
                              name="policylevelIncidentLimits" 
                              value={info.policylevelIncidentLimits} 
                              onChange={(e) => 
                                handleChange(e, ind, "policylevelIncidentLimits") 
                              } 
                              className="form-control" 
                            /> 
                          ) : ( 
                            info.policylevelIncidentLimits 
                          )} 
                        </td> 
                        ...
                        <td> 
                          {!info.submitted ? ( 
                            <input 
                              type="text" 
                              name="policylevelPerPersonLimit" 
                              value={info.policylevelPerPersonLimit} 
                              onChange={(e) => 
                                handleChange(e, ind, "policylevelPerPersonLimit") 
                              } 
                              className="form-control" 
                            /> 
                          ) : ( 
                            info.policylevelPerPersonLimit 
                          )} 
                        </td> 
                      </tr> 
                    ) 
...
const PolicylevelData = () => { 
  return policylevelDataObj 
} 
 
export default Policylevel; 
export {PolicylevelData};  
